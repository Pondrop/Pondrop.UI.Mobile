...
class StoreApi {
  ...
  Future<StoreSearchResultDto> searchStores({
    ...
    var url = '${_baseUrl}indexes/azuresql-index-stores/docs?api-version=2021-04-30-Preview&search=$keyword*&\$top=20&\$skip=$skipIdx&';

    if (sortByPosition != null) {
      url += '\$orderby=geo.distance(locationsort, geography\'POINT(${sortByPosition.longitude} ${sortByPosition.latitude})\') asc&';
    }
